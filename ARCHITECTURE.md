...
（`regen.sh` / `postprocess.py`），是 [`ws63-pac`](https://github.com/hispark-rs/ws63-pac) 的上游真值，
经 svd2rust 生成 PAC。

完整架构与评审（集中维护于主仓库）：
- 组件文档：<https://github.com/hispark-rs/ws63-rs/blob/main/docs/architecture/ws63-svd.md>
